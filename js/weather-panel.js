(function () {
  ...
  // ——— Public API ———
  window.openWeatherPanel = function openWeatherPanel() {
    ...
    if (!panel) {
      ...
      panel.innerHTML = `
        ...
        <iframe src="panels/weather-panel.html" style="border:0;width:100%;height:calc(100% - 40px);" loading="lazy" referrerpolicy="no-referrer"></iframe>
      `;
