(function () {
  ...
  // ——— Public API ———
  window.openJournalPanel = function openJournalPanel() {
    ...
    if (!panel) {
      ...
      panel.innerHTML = `
        ...
        <iframe src="panels/journal-panel.html" style="border:0;width:100%;height:calc(100% - 40px);" loading="lazy" referrerpolicy="no-referrer"></iframe>
      `;
